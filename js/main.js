...
class ChronoSwarmApp {
    ...
    handleError(error, context) {
        ...
        if (this.uiSystem) {
            this.uiSystem.showNotification(`An error occurred: ${error.message}`, 'error');
        }
    ...
    handleLowPerformance(fps) {
        ...
        if (this.particleSystem) {
            ...
            console.log(`🔧 Reduced max particles to ${this.particleSystem.maxParticles}`);
        }
        ...
        if (this.uiSystem) {
            this.uiSystem.showNotification('Performance optimized for your device', 'info');
        }
    }
    ...
    showStartupNotifications() {
        ...
        if (this.playerProgression) {
            ...
            if (lastLogin !== today) {
                setTimeout(() => {
                    if (this.uiSystem) {
                        this.uiSystem.showNotification('Daily login bonus received! 🎁', 'success');
                    }
